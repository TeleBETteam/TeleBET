...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #telebetcoinTEST\r");
            Send(hSocket, "WHO #telebetcoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #telebetcoin\n");
            // randomly join #telebetcoin00-#telebetcoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #telebetcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #telebetcoin%02d\r", channel_number).c_str());
        };
